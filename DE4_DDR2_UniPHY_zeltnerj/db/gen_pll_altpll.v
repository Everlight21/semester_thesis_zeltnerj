//altpll bandwidth_type="AUTO" CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" clk0_divide_by=50 clk0_duty_cycle=50 clk0_multiply_by=81 clk0_phase_shift="0" compensate_clock="CLK0" device_family="Stratix IV" inclk0_input_frequency=10000 intended_device_family="Stratix IV" lpm_hint="CBX_MODULE_PREFIX=gen_pll" operation_mode="normal" pll_type="LEFT_RIGHT" port_clk0="PORT_USED" port_clk1="PORT_UNUSED" port_clk2="PORT_UNUSED" port_clk3="PORT_UNUSED" port_clk4="PORT_UNUSED" port_clk5="PORT_UNUSED" port_clk6="PORT_UNUSED" port_clk7="PORT_UNUSED" port_clk8="PORT_UNUSED" port_clk9="PORT_UNUSED" port_inclk1="PORT_UNUSED" port_phasecounterselect="PORT_UNUSED" port_phasedone="PORT_UNUSED" port_scandata="PORT_USED" port_scandataout="PORT_USED" scan_chain_mif_file="gen_pll.mif" self_reset_on_loss_lock="OFF" using_fbmimicbidir_port="OFF" width_clock=10 areset clk configupdate inclk locked scanclk scanclkena scandata scandataout scandone CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//CBXI_INSTANCE_NAME="cmv4000design_vpg_inst8_gen_pll_gen_pll_inst_altpll_altpll_component"
...
`endif
	...
	defparam
		...
		pll1.clk0_multiply_by = 81,
		pll1.clk0_phase_shift = "0",
		pll1.compensate_clock = "clk0",
		pll1.inclk0_input_frequency = 10000,
		pll1.operation_mode = "normal",
		pll1.pll_type = "LEFT_RIGHT",
		pll1.scan_chain_mif_file = "gen_pll.mif",
