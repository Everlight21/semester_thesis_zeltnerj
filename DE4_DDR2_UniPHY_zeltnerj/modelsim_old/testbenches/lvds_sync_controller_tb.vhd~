...
architecture Behavioral of lvds_sync_controller_tb is
  ...
  signal LVDSDataxD         : std_logic_vector((8+1)*channelWidth-1 downto 0);
  signal ButtonxS           : std_logic_vector (3 downto 0);
  signal FrameReqInxS       : std_logic;
  signal AlignxS            : std_logic_vector(9-1 downto 0);
  signal PixelDataxD        : std_logic_vector(79 downto 0);
