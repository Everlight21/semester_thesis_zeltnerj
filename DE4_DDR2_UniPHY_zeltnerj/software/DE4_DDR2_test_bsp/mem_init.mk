...
RESET_ADDRESS ?= 0x61020000

#-------------------------------------
# Pre-Initialized Memory Descriptions
#-------------------------------------

# Memory: mem_if_ddr2_emif
MEM_0 := mem_if_ddr2_emif
$(MEM_0)_NAME := mem_if_ddr2_emif
$(MEM_0)_MEM_INIT_FILE_PARAM_NAME := ABS_RAM_MEM_INIT_FILENAME
$(MEM_0)_START := 0x00000000
$(MEM_0)_END := 0x3fffffff
$(MEM_0)_HIERARCHICAL_PATH := mem_if_ddr2_emif
$(MEM_0)_WIDTH := 256
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0


# Memory: mem_if_ddr2_emif_0
MEM_1 := mem_if_ddr2_emif_0
$(MEM_1)_NAME := mem_if_ddr2_emif_0
$(MEM_1)_MEM_INIT_FILE_PARAM_NAME := ABS_RAM_MEM_INIT_FILENAME
$(MEM_1)_START := 0x40000000
$(MEM_1)_END := 0x5fffffff
$(MEM_1)_HIERARCHICAL_PATH := mem_if_ddr2_emif_0
$(MEM_1)_WIDTH := 256
...
MEM_2 := DE4_QSYS_onchip_memory
$(MEM_2)_NAME := onchip_memory
...
$(MEM_2)_START := 0x61020000
$(MEM_2)_END := 0x6103f3ff
$(MEM_2)_HIERARCHICAL_PATH := onchip_memory
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: onchip_memory
onchip_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
