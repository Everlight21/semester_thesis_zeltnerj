...
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../DE4_QSYS.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x60000060
SOPC_SYSID_FLAG += --sidp=0x60000060
ELF_PATCH_FLAG  += --sidp 0x60000060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1354280312
SOPC_SYSID_FLAG += --timestamp=1354280312
ELF_PATCH_FLAG  += --timestamp 1354280312
