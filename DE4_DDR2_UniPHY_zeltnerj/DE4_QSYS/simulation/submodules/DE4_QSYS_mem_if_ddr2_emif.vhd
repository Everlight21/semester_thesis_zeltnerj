...
entity DE4_QSYS_mem_if_ddr2_emif is
	port (
		...
		avl_size          : in    std_logic_vector(7 downto 0)   := (others => '0'); --             .burstcount
...
end entity DE4_QSYS_mem_if_ddr2_emif;

architecture rtl of DE4_QSYS_mem_if_ddr2_emif is
	component DE4_QSYS_mem_if_ddr2_emif_pll0 is
		port (
	...
	end component DE4_QSYS_mem_if_ddr2_emif_pll0;

	component DE4_QSYS_mem_if_ddr2_emif_p0 is
		port (
			global_reset_n              : in    std_logic                      := 'X';             -- reset_n
			...
			afi_addr                    : in    std_logic_vector(27 downto 0)  := (others => 'X'); -- afi_addr
			...
			afi_cas_n                   : in    std_logic_vector(1 downto 0)   := (others => 'X'); -- afi_cas_n
			...
			afi_dqs_burst               : in    std_logic_vector(15 downto 0)  := (others => 'X'); -- afi_dqs_burst
			afi_wdata_valid             : in    std_logic_vector(15 downto 0)  := (others => 'X'); -- afi_wdata_valid
			afi_wdata                   : in    std_logic_vector(255 downto 0) := (others => 'X'); -- afi_wdata
			afi_dm                      : in    std_logic_vector(31 downto 0)  := (others => 'X'); -- afi_dm
			afi_rdata                   : out   std_logic_vector(255 downto 0);                    -- afi_rdata
			...
			afi_rdata_valid             : out   std_logic_vector(1 downto 0);                      -- afi_rdata_valid
			...
			phy_read_fifo_q             : out   std_logic_vector(255 downto 0);                    -- phy_read_fifo_q
			calib_skip_steps            : out   std_logic_vector(7 downto 0);                      -- calib_skip_steps
			scc_data                    : in    std_logic                      := 'X';             -- scc_data
			...
			dll_delayctrl               : in    std_logic_vector(5 downto 0)   := (others => 'X'); -- dll_delayctrl
			seriesterminationcontrol    : in    std_logic_vector(13 downto 0)  := (others => 'X'); -- seriesterminationcontrol
			parallelterminationcontrol  : in    std_logic_vector(13 downto 0)  := (others => 'X'); -- parallelterminationcontrol
	...
	end component DE4_QSYS_mem_if_ddr2_emif_p0;

	component afi_mux_ddrx is
		generic (
		...
		port (
			...
			afi_wlat              : out std_logic_vector(5 downto 0);                      -- afi_wlat
			afi_rlat              : out std_logic_vector(5 downto 0);                      -- afi_rlat
			seq_mux_addr          : in  std_logic_vector(27 downto 0)  := (others => 'X'); -- afi_addr
			...
			seq_mux_cas_n         : in  std_logic_vector(1 downto 0)   := (others => 'X'); -- afi_cas_n
			...
			seq_mux_dqs_burst     : in  std_logic_vector(15 downto 0)  := (others => 'X'); -- afi_dqs_burst
			seq_mux_wdata_valid   : in  std_logic_vector(15 downto 0)  := (others => 'X'); -- afi_wdata_valid
			seq_mux_wdata         : in  std_logic_vector(255 downto 0) := (others => 'X'); -- afi_wdata
			seq_mux_dm            : in  std_logic_vector(31 downto 0)  := (others => 'X'); -- afi_dm
			seq_mux_rdata         : out std_logic_vector(255 downto 0);                    -- afi_rdata
			...
			seq_mux_rdata_valid   : out std_logic_vector(1 downto 0);                      -- afi_rdata_valid
			phy_mux_addr          : out std_logic_vector(27 downto 0);                     -- afi_addr
			...
			phy_mux_cas_n         : out std_logic_vector(1 downto 0);                      -- afi_cas_n
			...
			phy_mux_dqs_burst     : out std_logic_vector(15 downto 0);                     -- afi_dqs_burst
			phy_mux_wdata_valid   : out std_logic_vector(15 downto 0);                     -- afi_wdata_valid
			phy_mux_wdata         : out std_logic_vector(255 downto 0);                    -- afi_wdata
			phy_mux_dm            : out std_logic_vector(31 downto 0);                     -- afi_dm
			phy_mux_rdata         : in  std_logic_vector(255 downto 0) := (others => 'X'); -- afi_rdata
			...
			phy_mux_rdata_valid   : in  std_logic_vector(1 downto 0)   := (others => 'X'); -- afi_rdata_valid
	...
	end component afi_mux_ddrx;

	component DE4_QSYS_mem_if_ddr2_emif_s0 is
		port (
			...
			scc_data                    : out std_logic;                                         -- scc_data
			...
			phy_read_fifo_q             : in  std_logic_vector(255 downto 0) := (others => 'X'); -- phy_read_fifo_q
			...
			afi_addr                    : out std_logic_vector(27 downto 0);                     -- afi_addr
			...
			afi_dqs_burst               : out std_logic_vector(15 downto 0);                     -- afi_dqs_burst
			afi_wdata_valid             : out std_logic_vector(15 downto 0);                     -- afi_wdata_valid
			afi_wdata                   : out std_logic_vector(255 downto 0);                    -- afi_wdata
			afi_dm                      : out std_logic_vector(31 downto 0);                     -- afi_dm
			afi_rdata                   : in  std_logic_vector(255 downto 0) := (others => 'X'); -- afi_rdata
	...
	end component DE4_QSYS_mem_if_ddr2_emif_s0;

	component DE4_QSYS_mem_if_ddr2_emif_c0 is
		port (
			afi_reset_n         : in  std_logic                      := 'X';             -- reset_n
			afi_clk             : in  std_logic                      := 'X';             -- clk
			afi_half_clk        : in  std_logic                      := 'X';             -- clk
			...
			afi_dm              : out std_logic_vector(31 downto 0);                     -- afi_dm
			afi_rdata           : in  std_logic_vector(255 downto 0) := (others => 'X'); -- afi_rdata
			afi_mem_clk_disable : out std_logic_vector(1 downto 0);                      -- afi_mem_clk_disable
	...
	end component DE4_QSYS_mem_if_ddr2_emif_c0;

	component altera_mem_if_oct_stratixiv is
		generic (
		...
		port (
			...
			seriesterminationcontrol   : out std_logic_vector(13 downto 0);        -- seriesterminationcontrol
			parallelterminationcontrol : out std_logic_vector(13 downto 0)         -- parallelterminationcontrol
		);
	end component altera_mem_if_oct_stratixiv;

	component altera_mem_if_dll_stratixiv is
		generic (
	...
	end component altera_mem_if_dll_stratixiv;

	signal pll0_afi_clk_clk                            : std_logic;                      -- pll0:afi_clk -> [afi_clk, c0:afi_clk, p0:afi_clk, s0:afi_clk]
	...
	signal p0_addr_cmd_clk_clk                         : std_logic;                      -- p0:addr_cmd_clk -> m0:clk
	signal m0_phy_mux_afi_addr                         : std_logic_vector(27 downto 0);  -- m0:phy_mux_addr -> p0:afi_addr
	signal m0_phy_mux_afi_odt                          : std_logic_vector(1 downto 0);   -- m0:phy_mux_odt -> p0:afi_odt
	...
	signal m0_phy_mux_afi_cs_n                         : std_logic_vector(1 downto 0);   -- m0:phy_mux_cs_n -> p0:afi_cs_n
	signal m0_phy_mux_afi_wdata                        : std_logic_vector(255 downto 0); -- m0:phy_mux_wdata -> p0:afi_wdata
	signal m0_phy_mux_afi_rdata_en                     : std_logic_vector(1 downto 0);   -- m0:phy_mux_rdata_en -> p0:afi_rdata_en
	signal m0_phy_mux_afi_cas_n                        : std_logic_vector(1 downto 0);   -- m0:phy_mux_cas_n -> p0:afi_cas_n
	signal p0_afi_afi_cal_success                      : std_logic;                      -- p0:afi_cal_success -> m0:phy_mux_cal_success
	signal m0_phy_mux_afi_ras_n                        : std_logic_vector(1 downto 0);   -- m0:phy_mux_ras_n -> p0:afi_ras_n
	signal p0_afi_afi_rlat                             : std_logic_vector(5 downto 0);   -- p0:afi_rlat -> m0:phy_mux_rlat
	signal p0_afi_afi_rdata                            : std_logic_vector(255 downto 0); -- p0:afi_rdata -> m0:phy_mux_rdata
	signal p0_afi_afi_cal_fail                         : std_logic;                      -- p0:afi_cal_fail -> m0:phy_mux_cal_fail
	signal m0_phy_mux_afi_wdata_valid                  : std_logic_vector(15 downto 0);  -- m0:phy_mux_wdata_valid -> p0:afi_wdata_valid
	signal m0_phy_mux_afi_dqs_burst                    : std_logic_vector(15 downto 0);  -- m0:phy_mux_dqs_burst -> p0:afi_dqs_burst
	signal m0_phy_mux_afi_dm                           : std_logic_vector(31 downto 0);  -- m0:phy_mux_dm -> p0:afi_dm
	...
	signal m0_afi_afi_rdata                            : std_logic_vector(255 downto 0); -- m0:afi_rdata -> c0:afi_rdata
	...
	signal s0_afi_afi_addr                             : std_logic_vector(27 downto 0);  -- s0:afi_addr -> m0:seq_mux_addr
	signal s0_afi_afi_odt                              : std_logic_vector(1 downto 0);   -- s0:afi_odt -> m0:seq_mux_odt
	...
	signal s0_afi_afi_cke                              : std_logic_vector(1 downto 0);   -- s0:afi_cke -> m0:seq_mux_cke
	signal s0_afi_afi_cs_n                             : std_logic_vector(1 downto 0);   -- s0:afi_cs_n -> m0:seq_mux_cs_n
	signal s0_afi_afi_wdata                            : std_logic_vector(255 downto 0); -- s0:afi_wdata -> m0:seq_mux_wdata
	signal s0_afi_afi_rdata_en                         : std_logic_vector(1 downto 0);   -- s0:afi_rdata_en -> m0:seq_mux_rdata_en
	signal s0_afi_afi_cas_n                            : std_logic_vector(1 downto 0);   -- s0:afi_cas_n -> m0:seq_mux_cas_n
	signal s0_afi_afi_ras_n                            : std_logic_vector(1 downto 0);   -- s0:afi_ras_n -> m0:seq_mux_ras_n
	signal m0_seq_mux_afi_rdata                        : std_logic_vector(255 downto 0); -- m0:seq_mux_rdata -> s0:afi_rdata
	signal s0_afi_afi_wdata_valid                      : std_logic_vector(15 downto 0);  -- s0:afi_wdata_valid -> m0:seq_mux_wdata_valid
	signal s0_afi_afi_dqs_burst                        : std_logic_vector(15 downto 0);  -- s0:afi_dqs_burst -> m0:seq_mux_dqs_burst
	signal s0_afi_afi_dm                               : std_logic_vector(31 downto 0);  -- s0:afi_dm -> m0:seq_mux_dm
	...
	signal p0_phy_phy_read_fifo_q                      : std_logic_vector(255 downto 0); -- p0:phy_read_fifo_q -> s0:phy_read_fifo_q
	...
	signal s0_scc_scc_data                             : std_logic;                      -- s0:scc_data -> p0:scc_data
	signal c0_afi_afi_addr                             : std_logic_vector(27 downto 0);  -- c0:afi_addr -> m0:afi_addr
	signal c0_afi_afi_odt                              : std_logic_vector(1 downto 0);   -- c0:afi_odt -> m0:afi_odt
	...
	signal c0_afi_afi_cke                              : std_logic_vector(1 downto 0);   -- c0:afi_cke -> m0:afi_cke
	signal c0_afi_afi_cs_n                             : std_logic_vector(1 downto 0);   -- c0:afi_cs_n -> m0:afi_cs_n
	signal c0_afi_afi_wdata                            : std_logic_vector(255 downto 0); -- c0:afi_wdata -> m0:afi_wdata
	signal c0_afi_afi_rdata_en                         : std_logic_vector(1 downto 0);   -- c0:afi_rdata_en -> m0:afi_rdata_en
	signal c0_afi_afi_cas_n                            : std_logic_vector(1 downto 0);   -- c0:afi_cas_n -> m0:afi_cas_n
	signal c0_afi_afi_ras_n                            : std_logic_vector(1 downto 0);   -- c0:afi_ras_n -> m0:afi_ras_n
	signal c0_afi_afi_mem_clk_disable                  : std_logic_vector(1 downto 0);   -- c0:afi_mem_clk_disable -> p0:afi_mem_clk_disable
	signal c0_afi_afi_init_req                         : std_logic;                      -- c0:afi_init_req -> s0:afi_init_req
	signal c0_afi_afi_wdata_valid                      : std_logic_vector(15 downto 0);  -- c0:afi_wdata_valid -> m0:afi_wdata_valid
	signal c0_afi_afi_dqs_burst                        : std_logic_vector(15 downto 0);  -- c0:afi_dqs_burst -> m0:afi_dqs_burst
	signal c0_afi_afi_dm                               : std_logic_vector(31 downto 0);  -- c0:afi_dm -> m0:afi_dm
	signal oct0_oct_sharing_parallelterminationcontrol : std_logic_vector(13 downto 0);  -- oct0:parallelterminationcontrol -> p0:parallelterminationcontrol
	signal oct0_oct_sharing_seriesterminationcontrol   : std_logic_vector(13 downto 0);  -- oct0:seriesterminationcontrol -> p0:seriesterminationcontrol
	signal pll0_pll_sharing_pll_avl_clk                : std_logic;                      -- pll0:pll_avl_clk -> p0:pll_avl_clk
	signal pll0_pll_sharing_pll_config_clk             : std_logic;                      -- pll0:pll_config_clk -> p0:pll_config_clk
	signal pll0_pll_sharing_pll_addr_cmd_clk           : std_logic;                      -- pll0:pll_addr_cmd_clk -> p0:pll_addr_cmd_clk
	signal pll0_pll_sharing_pll_mem_clk                : std_logic;                      -- pll0:pll_mem_clk -> p0:pll_mem_clk
	signal pll0_pll_sharing_pll_locked                 : std_logic;                      -- pll0:pll_locked -> p0:pll_locked
	signal pll0_pll_sharing_pll_write_clk_pre_phy_clk  : std_logic;                      -- pll0:pll_write_clk_pre_phy_clk -> p0:pll_write_clk_pre_phy_clk
	signal pll0_pll_sharing_pll_write_clk              : std_logic;                      -- pll0:pll_write_clk -> p0:pll_write_clk
	...
	signal dll0_dll_sharing_dll_delayctrl              : std_logic_vector(5 downto 0);   -- dll0:dll_delayctrl -> p0:dll_delayctrl

begin

	pll0 : component DE4_QSYS_mem_if_ddr2_emif_pll0
		port map (
	...
	p0 : component DE4_QSYS_mem_if_ddr2_emif_p0
		port map (
			global_reset_n              => global_reset_n,                              --        global_reset.reset_n
	...
	s0 : component DE4_QSYS_mem_if_ddr2_emif_s0
		port map (
			avl_clk                     => p0_avl_clk_clk,                     --          avl_clk.clk
			avl_reset_n                 => p0_avl_reset_reset,                 --        avl_reset.reset_n
			scc_clk                     => p0_scc_clk_clk,                     --          scc_clk.clk
			...
			phy_write_fr_cycle_shifts   => open                                --      (terminated)
		);

	c0 : component DE4_QSYS_mem_if_ddr2_emif_c0
		port map (
			afi_reset_n         => p0_afi_reset_reset,         --    afi_reset.reset_n
			afi_clk             => pll0_afi_clk_clk,           --      afi_clk.clk
			afi_half_clk        => pll0_afi_half_clk_clk,      -- afi_half_clk.clk
	...
	oct0 : component altera_mem_if_oct_stratixiv
		generic map (
	...
	dll0 : component altera_mem_if_dll_stratixiv
		generic map (
...
end architecture rtl; -- of DE4_QSYS_mem_if_ddr2_emif
