...
# ACDS 12.1sp1 243 win32 2013.07.29.16:54:55
...
alias dev_com {
  ...
  vlog  "c:/altera/12.1sp1/quartus/eda/sim_lib/altera_lnsim.sv"                   -work altera_lnsim      
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L no_of_cam_channels -L spi_2 -L mm_clock_crossing_bridge_io -L button -L led -L timer -L sysid -L jtag_uart -L nios2_qsys -L mem_if_ddr2_emif -L onchip_memory -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L stratixiv_hssi -L stratixiv_pcie_hip -L stratixiv $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L no_of_cam_channels -L spi_2 -L mm_clock_crossing_bridge_io -L button -L led -L timer -L sysid -L jtag_uart -L nios2_qsys -L mem_if_ddr2_emif -L onchip_memory -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L stratixiv_hssi -L stratixiv_pcie_hip -L stratixiv $TOP_LEVEL_NAME
}
