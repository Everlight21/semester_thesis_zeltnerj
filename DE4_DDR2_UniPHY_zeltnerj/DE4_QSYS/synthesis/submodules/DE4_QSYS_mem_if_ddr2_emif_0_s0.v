// DE4_QSYS_mem_if_ddr2_emif_0_s0.v

// This file was auto-generated from qsys_sequencer_110_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 12.1 177 at 2012.12.03.15:40:41

`timescale 1 ps / 1 ps
module DE4_QSYS_mem_if_ddr2_emif_0_s0 (
	...
	rw_manager_ddr2 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("STRATIXIV"),
		.AC_ROM_INIT_FILE_NAME                ("DE4_QSYS_mem_if_ddr2_emif_0_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("DE4_QSYS_mem_if_ddr2_emif_0_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (13312),
		.INIT_FILE        ("DE4_QSYS_mem_if_ddr2_emif_0_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_addr_router addr_router (
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_addr_router_001 addr_router_001 (
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_id_router id_router (
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_id_router id_router_001 (
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_id_router id_router_002 (
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_id_router_003 id_router_003 (
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_id_router id_router_004 (
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_id_router id_router_005 (
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_cmd_xbar_demux cmd_xbar_demux (
		.clk                (avl_clk),                           //       clk.clk
		.reset              (rst_controller_reset_out_reset),    // clk_reset.reset
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_cmd_xbar_demux_001 cmd_xbar_demux_001 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_cmd_xbar_mux_003 cmd_xbar_mux_003 (
		.clk                 (avl_clk),                               //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_cmd_xbar_demux_001 rsp_xbar_demux (
		.clk                (avl_clk),                           //       clk.clk
		.reset              (rst_controller_reset_out_reset),    // clk_reset.reset
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_cmd_xbar_demux_001 rsp_xbar_demux_001 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_cmd_xbar_demux_001 rsp_xbar_demux_002 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_rsp_xbar_demux_003 rsp_xbar_demux_003 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_cmd_xbar_demux_001 rsp_xbar_demux_004 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_cmd_xbar_demux_001 rsp_xbar_demux_005 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_rsp_xbar_mux rsp_xbar_mux (
		.clk                 (avl_clk),                               //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	DE4_QSYS_mem_if_ddr2_emif_0_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                        //       clk.clk
		.reset      (rst_controller_reset_out_reset), // clk_reset.reset
