...
#      in the DE4_QSYS_mem_if_ddr2_emif_p0_timing.tcl script.
#    * The helper routines are defined in DE4_QSYS_mem_if_ddr2_emif_p0_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/DE4_QSYS_mem_if_ddr2_emif_p0_parameters.tcl"
source "$script_dir/DE4_QSYS_mem_if_ddr2_emif_p0_timing.tcl"
source "$script_dir/DE4_QSYS_mem_if_ddr2_emif_p0_pin_map.tcl"
...
set entity_names_on [ DE4_QSYS_mem_if_ddr2_emif_p0_are_entity_names_on ]
	...
	set io_standard "$::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_io_standard CLASS I"
...
if { ! [ info exists DE4_QSYS_mem_if_ddr2_emif_p0_sdc_cache ] } {
	set DE4_QSYS_mem_if_ddr2_emif_p0_sdc_cache 1
	DE4_QSYS_mem_if_ddr2_emif_p0_initialize_ddr_db DE4_QSYS_mem_if_ddr2_emif_p0_ddr_db
} else {
	if { $debug } {
...
# following loop
set instances [ array names DE4_QSYS_mem_if_ddr2_emif_p0_ddr_db ]
foreach { inst } $instances {
	if { [ info exists pins ] } {
		# Clean-up stale content
		unset pins
	}
	array set pins $DE4_QSYS_mem_if_ddr2_emif_p0_ddr_db($inst)
	...
	set fpga(tDQS_PHASE_JITTER) [ expr [ get_integer_node_delay -integer $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_delay_chain_length -parameters {IO MAX HIGH} -src DQS_PHASE_JITTER -in_fitter ] / 1000.0 ]

	# Phase Error on DQS paths. This parameter is queried at run time
	set fpga(tDQS_PSERR) [ expr [ get_integer_node_delay -integer $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_delay_chain_length -parameters {IO MAX HIGH} -src DQS_PSERR -in_fitter ] / 1000.0 ]
	...
	if { $debug } {
		...
		post_message -type info "SDC: -----------------"
		post_message -type info "SDC:    DQS Phase: $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_delay_chain_length"
	...
	# W A R N I N G !
	# The PLL parameters are statically defined in the DE4_QSYS_mem_if_ddr2_emif_p0_parameters.tcl
	...
	# apply those changes to the PLL parameters in the DE4_QSYS_mem_if_ddr2_emif_p0_parameters.tcl

	set pll_i 5
	create_generated_clock -add -name "$local_pll_afi_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_pll_mult(0) -divide_by $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_pll_div(0) -phase $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_pll_phase(0) $pll_afi_clock
	if {[string compare -nocase $pll_afi_clock $pll_ck_clock]==0} {
		set local_pll_mem_clk $local_pll_afi_clk
	} else {
		create_generated_clock -add -name "$local_pll_mem_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_pll_mult(1) -divide_by $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_pll_div(1) -phase $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_pll_phase(1) $pll_ck_clock
	}
	...
	if {[string compare -nocase $pll_afi_clock $pll_avl_clock]==0} {
		...
		create_generated_clock -add -name "$local_pll_avl_clock" -source $pll_ref_clock -multiply_by $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_pll_mult($pll_i) -divide_by $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_pll_div($pll_i) -phase $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_pll_phase($pll_i) $pll_avl_clock
	}
	incr pll_i
	...
	if {(($::quartus(nameofexecutable) ne "quartus_fit") && ($::quartus(nameofexecutable) ne "quartus_map"))} {
		set dqs_clocks [DE4_QSYS_mem_if_ddr2_emif_p0_get_all_instances_dqs_pins DE4_QSYS_mem_if_ddr2_emif_p0_ddr_db]
...
add_ddr_report_command "source [list [file join [file dirname [info script]] ${::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename}_report_timing.tcl]]"
