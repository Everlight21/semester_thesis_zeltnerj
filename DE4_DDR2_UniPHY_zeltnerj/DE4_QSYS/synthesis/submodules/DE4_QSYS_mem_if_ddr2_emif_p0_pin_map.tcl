...
# DE4_QSYS_mem_if_ddr2_emif_p0_pin_assignments.tcl and DE4_QSYS_mem_if_ddr2_emif_p0.sdc scripts. 
#
...
proc DE4_QSYS_mem_if_ddr2_emif_p0_sort_proc {a b} {
	set idxs [list 1 2 0]
	foreach i $idxs {
		set ai [lindex $a $i]
		set bi [lindex $b $i]
...
proc DE4_QSYS_mem_if_ddr2_emif_p0_get_dqs_phase { dqs_pins } {
	...
	if { $dqs_phase_setting != $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_delay_chain_length } {
		...
		post_message -type critical_warning "   Parameter value: $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_delay_chain_length"
...
proc DE4_QSYS_mem_if_ddr2_emif_p0_get_ddr_pins { instname allpins } {
	...
	for { set i 0 } { $i < $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_number_of_dqs_groups } { incr i } {
		...
		if { [llength $q_group] != $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_group_size} { 
			post_sdc_message critical_warning "Could not find correct number of D pins for K pin $i. \
				Found [llength $q_group] pins. Expecting ${::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_group_size}." 
		}
...
proc DE4_QSYS_mem_if_ddr2_emif_p0_initialize_ddr_db { ddr_db_par } {
	...
	foreach instname $instance_list {
		post_sdc_message info "Finding port-to-pin mapping for CORE: $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename INSTANCE: $instname"

		DE4_QSYS_mem_if_ddr2_emif_p0_get_ddr_pins $instname allpins

		DE4_QSYS_mem_if_ddr2_emif_p0_verify_ddr_pins allpins

		set local_ddr_db($instname) [ array get allpins ]
	}
}

proc DE4_QSYS_mem_if_ddr2_emif_p0_verify_ddr_pins { pins_par } {
	upvar $pins_par pins
	...
	if { $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_number_of_dm_pins != $counted_dm_pins } {
		post_message -type critical_warning "Unexpected number of detected DM pins: $counted_dm_pins"
		post_message -type critical_warning "   expected: $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_number_of_dm_pins"
	}
...
proc DE4_QSYS_mem_if_ddr2_emif_p0_get_all_instances_div_names { ddr_db_par } {
	upvar $ddr_db_par local_ddr_db
...
proc DE4_QSYS_mem_if_ddr2_emif_p0_get_all_instances_dqs_pins { ddr_db_par } {
	upvar $ddr_db_par local_ddr_db
...
proc DE4_QSYS_mem_if_ddr2_emif_p0_dump_all_pins { ddr_db_par } {
	upvar $ddr_db_par local_ddr_db

	set instnames [ array names local_ddr_db ]

	set filename "${::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename}_all_pins.txt"
	...
	puts $FH "# PIN MAP for core < $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename >"
	puts $FH "#"
	puts $FH "# Generated by ${::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename}_pin_assignments.tcl"
	puts $FH "#"
...
proc DE4_QSYS_mem_if_ddr2_emif_p0_dump_static_pin_map { ddr_db_par filename } {
	upvar $ddr_db_par local_ddr_db
	...
	puts $FH "# AUTO-GENERATED static pin map for core < $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename >"
	puts $FH ""
	puts $FH "proc ${::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename}_initialize_static_ddr_db { ddr_db_par } {"
