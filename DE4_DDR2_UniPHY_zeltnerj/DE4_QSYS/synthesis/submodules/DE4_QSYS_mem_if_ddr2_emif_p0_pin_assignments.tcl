...
# the DE4_QSYS_mem_if_ddr2_emif_p0_pin_map.tcl script.
# All the memory interface parameters are defined in the
# DE4_QSYS_mem_if_ddr2_emif_p0_parameters.tcl script
...
global ::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_io_standard
global ::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_io_standard_differential
global ::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_group_size
global ::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_number_of_dqs_groups
global ::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_uniphy_temp_ver_code
...
foreach asgn_type $asgn_types {
	remove_all_instance_assignments -tag __$::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename -name $asgn_type
}
...
DE4_QSYS_mem_if_ddr2_emif_p0_initialize_ddr_db ddr_db
...
foreach inst $instances {
	...
	foreach ac_pin $pins(ac_pins) {
		set_instance_assignment -name IO_STANDARD "$::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_io_standard CLASS I" -to $ac_pin -tag __$::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename
		set_instance_assignment -name CURRENT_STRENGTH_NEW "MAXIMUM CURRENT" -to $ac_pin -tag __$::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename
	}

	foreach dm_pin $pins(dm_pins) {
		set_instance_assignment -name IO_STANDARD "$::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_io_standard CLASS I" -to $dm_pin -tag __$::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename
		set_instance_assignment -name OUTPUT_TERMINATION "SERIES 50 OHM WITH CALIBRATION" -to $dm_pin -tag __$::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename
	}

	set ::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_group_size_constraint $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_group_size
	if { $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_group_size == 8 } {
		set ::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_group_size_constraint 9
	}
	foreach { dqs_pin } $pins(dqs_pins) { dq_pins } $pins(q_groups) {
		foreach dq_pin $dq_pins {
			set_instance_assignment -name DQ_GROUP $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_group_size_constraint -from $dqs_pin -to $dq_pin -tag __$::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename
		}
	}

	foreach { dqs_pin } $pins(dqs_pins) { dm_pin } $pins(dm_pins) {
		if { $dm_pin != "" } {
			set_instance_assignment -name DQ_GROUP $::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_dqs_group_size_constraint -from $dqs_pin -to $dm_pin -tag __$::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename
		}
	}
...
DE4_QSYS_mem_if_ddr2_emif_p0_dump_all_pins ddr_db

if { [ llength $quartus(args) ] > 1 } {
	set param [lindex $quartus(args) 1]

	if { [ string match -dump_static_pin_map $param ] } {
		set filename "${::GLOBAL_DE4_QSYS_mem_if_ddr2_emif_p0_corename}_static_pin_map.tcl"

		DE4_QSYS_mem_if_ddr2_emif_p0_dump_static_pin_map ddr_db $filename
	}
}
